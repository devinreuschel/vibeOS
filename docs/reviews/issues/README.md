...
**Status (2026-09-22).** C1 landed on main (#77). DOC1 and DOC3 are this docs/meta PR (rebased onto that). R1: merged `feature/*` branches pruned; ISO→`build/` waits on B1; Python driver moves wait on T2 (`tests/e2e/` already gone). **O1 superseded** — Phase 9 exit closed 2026-09-22; do not add a "Phase 9 resumed" note. Everything else still proposed.
