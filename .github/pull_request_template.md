...
- [ ] no ticked ROADMAP box changes its text unless this PR reopens it or names its proof again
- [ ] a ticked box whose text says its test fails before the fix has a `Fails-before:` line, and the test was pushed before the fix so CI ran it red
